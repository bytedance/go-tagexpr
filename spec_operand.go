...
func (ge *groupExprNode) Eval() interface{} {
	if ge.rightOperand == nil {
		return nil
	}
	v := ge.rightOperand.Eval()
	if r, ok := v.(bool); ok {
...
func (be *boolExprNode) Eval() interface{} { return be.val }
...
func (se *stringExprNode) Eval() interface{} { return se.val }
...
func (de *digitalExprNode) Eval() interface{} { return de.val }
